// components/WhyChooseUs.js - CORRECTED
...
const features = [
  ...
  { icon: '🤝', title: '24/7 Dedicated Support', description: 'Our partnership does not end at launch. We provide ongoing support to ensure your digital assets run flawlessly.' },
